            ...
            <div className="grid lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-5">
                <div className="bg-white rounded-lg p-8 h-full flex flex-col">
                  ...
                  {/* Avatars + Stats */}
                  <div className="mt-6 bg-white p-4 rounded-lg flex items-center gap-4 shadow-sm border border-gray-100">
                    <div className="flex -space-x-3">
                      <img
                        src="/static-sprintothon/images/profiles/profile-1.png"
                        alt="Runner 1"
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            {/* Event Row */}
            <div className="bg-white rounded-lg shadow-md overflow-hidden grid grid-cols-12 items-center">
              <div className="col-span-5 p-8">
                ...
                <p className="text-muted-foreground mb-4">
                  Lorem ipsum dolor sit amet consectetur, adipiscing elit
                  sagittis etiam, senectus cursus rhoncus nam.
                </p>
              ...
              <div className="col-span-4 p-8 flex flex-col items-center">
                ...
                <div className="text-sm text-gray-500 mb-4">/Ticket</div>
                <button className="px-6 py-3 bg-red-600 text-white rounded font-semibold hover:bg-red-700 transition">
                  Buy Ticket
                </button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden grid grid-cols-12 items-center">
              ...
              <div className="col-span-4 p-8 flex flex-col items-center">
                <div className="text-4xl font-extrabold mb-2">$28</div>
                <div className="text-sm text-gray-500 mb-4">/Ticket</div>
                <button className="px-6 py-3 bg-red-600 text-white rounded font-semibold hover:bg-red-700 transition">
                  Buy Ticket
                </button>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group relative">
              ...
              <div className="mt-4">
                <h3 className="text-2xl font-extrabold">Ethan Cole</h3>
                <p className="text-muted-foreground">Running Coach</p>
              </div>
            </div>
            ...
            <div className="group relative">
              ...
              <div className="mt-4">
                <h3 className="text-2xl font-extrabold">Ava Mitchell</h3>
                <p className="text-muted-foreground">Endurance Coach</p>
              </div>
            </div>
            ...
            <div className="group relative">
              ...
              <div className="mt-4">
                <h3 className="text-2xl font-extrabold">Liam Turner</h3>
                <p className="text-muted-foreground">Strength Trainer</p>
              </div>
            </div>
          </div>
        </div>
